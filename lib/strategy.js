...
function Strategy(options, verify) {
  ...
  this._profileFieldsMap = options.profileFieldsMap || null;
}
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  if (this._profileFields) {
    var fields = this._convertProfileFields(this._profileFields, this._profileFieldsMap);
 ...
 * @api protected
 */
Strategy.prototype._convertProfileFields = function(profileFields, map) {
